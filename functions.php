<?php
/**
 * ZuxTheme functions and definitions
 *
...
function zuxtheme_setup()
{
	...
	*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'zuxtheme_custom_background_args',
			array(
 ...
 */
function zuxtheme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'zuxtheme_content_width', 640 );
}
add_action( 'after_setup_theme', 'zuxtheme_content_width', 0 );
 ...
 */
function zuxtheme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'zuxtheme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'zuxtheme' ),
...
add_action( 'widgets_init', 'zuxtheme_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'zuxtheme_scripts' );
